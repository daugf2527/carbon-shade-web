...
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:16` | `data-surface` | 2 | 只绑定动作表/类型/事件壳，属于最便宜的清理层。 | 先把这层从 src/combat/* 拆到 data/runtime 入口。 |
...
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:28` | `tests/static/config-validate.test.ts` | `data-surface` | `import { ACTIONS } from "../../src/combat/actions/FrameDataAction.js";`<br>`import type { ActionName, StatusEffectType } from "../../src/combat/types.js";` | P5-A |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:29` | `tests/static/damage-routing.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:30` | `tests/static/death-barrier-multihit.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:31` | `tests/static/death-loop.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";`<br>`import { CombatEventPriority } from "../../src/combat/events/CombatEventBus.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:32` | `tests/static/debug-actions.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:33` | `tests/static/dfo-replica.test.ts` | `kernel-shell` | `import { getAction } from "../../src/combat/actions/FrameDataAction.js";`<br>`import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:34` | `tests/static/enemy-ai.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:35` | `tests/static/event-bus.test.ts` | `data-surface` | `import { CombatEventBus, CombatEventPriority } from "../../src/combat/events/CombatEventBus.js";` | P5-A |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:36` | `tests/static/fuzz-combat.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:37` | `tests/static/handfeel-fix2.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:38` | `tests/static/hit-shape.test.ts` | `combat-subsystems` | `import type { HitBoxFrameWindow } from "../../src/combat/types.js";`<br>`import { createActor } from "../../src/combat/actors/ActorFactory.js";`<br>`import { HitResolver2D5 } from "../../src/combat/hit/HitResolver2D5.js";`<br>`import { HitDecisionResolver } from "../../src/combat/hit/HitDecisionResolver.js";`<br>`import { getAction } from "../../src/combat/actions/FrameDataAction.js";` | P5-C |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:39` | `tests/static/input-buffer.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:40` | `tests/static/jump-attack-hit-recoil.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:41` | `tests/static/jump-attack-z-detailed.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:42` | `tests/static/jump-attack-z-position.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:43` | `tests/static/jump-down-movement.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:44` | `tests/static/jump-hit-down-movement.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:45` | `tests/static/jump-skill-down-movement.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:46` | `tests/static/jump-x-cancel-stuck-airborne.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:47` | `tests/static/manifest-provenance.test.ts` | `replay-input` | `import type { ActionName, FrameDataAction, StatusProvenanceField } from "../../src/combat/types.js";`<br>`import { ACTIONS, getAction, loadFromManifest } from "../../src/combat/actions/FrameDataAction.js";`<br>`import { ReplayRecorder } from "../../src/combat/replay/ReplayRecorder.js";` | P5-B |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:48` | `tests/static/movement-bounds.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:49` | `tests/static/official-api-alignment.test.ts` | `kernel-shell` | `import { getAction } from "../../src/combat/actions/FrameDataAction.js";`<br>`import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:50` | `tests/static/replay-hash.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";`<br>`import { ReplayRecorder } from "../../src/combat/replay/ReplayRecorder.js";`<br>`import { createActor } from "../../src/combat/actors/ActorFactory.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:51` | `tests/static/replay-performance.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:52` | `tests/static/replay-schema.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:53` | `tests/static/replay.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:54` | `tests/static/run-detector.test.ts` | `replay-input` | `import { RunCommandDetector } from "../../src/combat/input/RunCommandDetector.js";`<br>`import type { RawInputFrame } from "../../src/combat/input/BrowserInputState.js";` | P5-B |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:55` | `tests/static/schema-hash-freshness.test.ts` | `replay-input` | `import { ReplayRecorder } from "../../src/combat/replay/ReplayRecorder.js";` | P5-B |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:56` | `tests/static/socd-cleaner.test.ts` | `replay-input` | `import { SOCDCleaner } from "../../src/combat/input/SOCDCleaner.js";` | P5-B |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:57` | `tests/static/status-buff.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:58` | `tests/static/status-profile.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:59` | `tests/static/tick-benchmark.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:60` | `tests/static/walk-run-z.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:61` | `tests/static/walk-run.test.ts` | `kernel-shell` | `import { CombatKernel } from "../../src/combat/kernel/CombatKernel.js";` | P5-D |
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:65` 1. static blocker 的真正主阻塞不是零散类型，而是 32 个直接依赖 `CombatKernel` / `FixedStepSimulation` 的 `kernel-shell` 用例。
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:66` 2. `data-surface` 只有 2 个文件，是最便宜的清理层；它们不该和 `CombatKernel` 主迁移耦在一起。
- `docs/engineering/p5-static-blocker-matrix-2026-06-10.md:68` 4. `replay-input` 4 个文件说明 replay / input 工具链仍是 `src/combat/` 删除前的独立尾巴。
