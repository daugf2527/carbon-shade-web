 ...
 *
 * ── HONEST COVERAGE (updated 2026-06-08, quick-rebound activation) ───────────────
 * engine currently has player + grunt actors, 5 swordman actions, a bleed DOT StatusSystem, an
 * armor profile system (Batch 3a), and a DownSystem (Stage 4B-B1). It can genuinely observe 5 of the
 * 7 flags; the other 2 require actors/systems engine does not exercise in the scenario yet and are
 * documented P4 gaps (kept in the type for forward-compat + uniform overlay with combat, but never
 * set true by the scenario):
 ...
 *   ✅ quickReboundObserved        — DownSystem quick-rebound fires (Stage 4B-B1; scenario sub-scenario 5)
