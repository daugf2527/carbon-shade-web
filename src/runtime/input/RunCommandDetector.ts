import type { BufferedInput, RawInputFrame, RuntimeBufferedActionName, RuntimeFacing } from "./InputTypes.js";
...
const directionFacing: Record<HorizontalDirection, RuntimeFacing> = {
  left: "left",
  right: "right",
};
...
export class RunCommandDetector {
  ...
  detect(frame: RawInputFrame, currentFacing: RuntimeFacing): BufferedInput[] {
