 ...
 * "98 curated files" claim.
 *
 * If you extend the baseline:
 *   - update EXPECTED_COUNT here
 *   - update CLAUDE.md "98 curated files" in Commands table
...
assert.equal(
  ...
  `CURATED_FILES drift: array has ${entries.length} entries != EXPECTED_COUNT ${EXPECTED_COUNT}. ` +
    `If you extended the baseline: update EXPECTED_COUNT here AND CLAUDE.md "98 curated files". ` +
